...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:html="http://www.w3.org/1999/xhtml" xmlns="http://www.w3.org/1999/xhtml" xmlns:f="http://hl7.org/fhir">
    ...
    <div>
      ...
      <xsl:for-each select="f:package|f:definition/f:package|f:definition/f:grouping">
        ...
        <xsl:variable name="relevantResources">
          ...
          parent::f:definition/f:resource[f:package/@value=current()/@id or f:groupingId/@value=current()/@name or f:groupingId/@value=$groupingname][not(f:extension[@url='http://hl7.org/fhir/StructureDefinition/tools-alternateVersion'] or $version) or (f:extension[@url='http://hl7.org/fhir/StructureDefinition/tools-alternateVersion']/f:valueCode/@value=$version)]">content</xsl:for-each>
        </xsl:variable>
  ...
  <xsl:template match="f:package|f:grouping">
    ...
    <p>
      <table>
        <tbody>
          <xsl:for-each select="parent::f:definition/f:resource">
<!--		  path: <xsl:value-of select="path()"/> .
		  groupingId: <xsl:value-of select="./f:groupingId/@value"/> .
		  current: <xsl:value-of select="f:current()/@name"/> .
-->
            <tr>
